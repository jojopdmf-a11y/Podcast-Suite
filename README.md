...
- **Fixer Mixer** — **SAVE MIX** writes `FixerMixer.mix.json` next to the tracks. Drop that folder later and the mix comes back. **LOAD MIX…** opens a mix file. You can also drop any audio files (each file becomes a channel).
