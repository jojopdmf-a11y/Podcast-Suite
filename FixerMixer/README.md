...
4. Click the waveform to seek. **Shift-drag** paints mute (silence — the show stays the same length). **Option-drag** clears a mute. The strip **MUTE** button is the whole channel; it cannot punch a cough.
